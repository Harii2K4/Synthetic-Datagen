...
function PersonaHubPage() {
  ...
  const upperLimit = useMemo(() => {
    const parsedUpper = coerceNonNegativeInteger(
      upperLimitText,
  ...
  return (
    <section className="generate-page">
      ...
      <section className="generate-section">
        ...
        <div className="field-grid">
          ...
          <label>
            ...
            <select
              value={previewMode}
              onChange={(event) =>
                setPreviewMode(event.target.value as CsvPreviewMethod)
              }
            >
        ...
        {previewMode !== "range" ? (
          <p className="muted-text">
            Origin filter (system/user) is available in the table toolbar.
          </p>
        ) : null}
      </section>
      ...
      <section className="generate-section">
        ...
        {!previewSource ? (
          <p className="muted-text">
            Select a persona split to load preview rows.
          </p>
        ) : (
          <CsvPreviewTable
