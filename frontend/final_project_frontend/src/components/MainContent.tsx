...
function MainContent({ activeTab, onTabSelect }: MainContentProps) {
  ...
  return (
    <section
      ...
      aria-live="polite"
    >
      <p className="mb-3 text-xs uppercase tracking-[0.45em] text-white/45">Selected Panel</p>
      <h2
      ...
      <p className="max-w-2xl text-base text-white/70">
        This panel is scaffolded but not fully implemented yet. You can continue with the generation
        flow now, then return to this area once data output pipelines are in place.
      </p>
